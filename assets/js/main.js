...
const scrollHeader = () =>{
    ...
    // When the scroll is higher than 50 viewport height, add the bg-header class to the header tag
...
sr.reveal(`.home__content, .popoular__container, .products__container, .join__bg, .footer__container`)
